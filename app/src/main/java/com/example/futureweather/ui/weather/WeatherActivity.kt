...
class WeatherActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (viewModel.locaitonLng.isEmpty()) {
            viewModel.locaitonLng = intent.getStringExtra("location_lng") ?: ""
        }
        ...
        LogUtil.i("test",viewModel.weatherLiveData.toString())
        viewModel.weatherLiveData.observe(this, Observer { result ->
            LogUtil.i("test",result.toString())
        ...
        viewModel.refreshWeather(viewModel.locaitonLng, viewModel.locationLat)
    }
