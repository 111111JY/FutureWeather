...
data class Sky(val info: String, val icon: Int, val animation: Int, val bg: Int)
    private val sky = mapOf(
        ...
        "THUNDER_SHOWER" to Sky(
            ...
            R.raw.animation_thunder_shower,
            R.drawable.bg_rain
        ),
        "SLEET" to Sky(
            "雨夹雪",
            R.drawable.ic_sleet,
            R.raw.animation_storm_rain,
            R.drawable.bg_rain
        ),
        "LIGHT_SNOW" to Sky(
            "小雪",//
            R.drawable.ic_light_snow,
            R.raw.animation_light_snow,
            R.drawable.bg_snow
        ),
        "MODERATE_SNOW" to Sky(
            "中雪",//
            R.drawable.ic_moderate_snow,
            R.raw.animation_heavy_snow,
            R.drawable.bg_snow
        ),
        "HEAVY_SNOW" to Sky(
            "大雪",//
        ...
        "HAIL" to Sky(
            "冰雹",//
            R.drawable.ic_hail,
            R.raw.animation_hail,
            R.drawable.bg_snow
        ),
        "LIGHT_HAZE" to Sky(
            "轻度雾霾",//
            R.drawable.ic_light_haze,
            R.raw.animation_haze,
            R.drawable.bg_fog
        ),
